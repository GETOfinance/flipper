...
/**
 * @title FlipperRegistry
 * @author Flipper Protocol
 * @notice ERC-8004 compatible AI Agent Registry for Ethereum.
 ...
 */
contract FlipperRegistry is ERC721Enumerable, Ownable, ReentrancyGuard {
    // ═══════════════════════════════════════════════════════════════
    //                        STRUCTS
    // ═══════════════════════════════════════════════════════════════
    ...
    constructor(
        ...
        uint256 _maxAgents
    ) ERC721("Flipper Guardian Agent", "FLIPPER") Ownable(msg.sender) {
