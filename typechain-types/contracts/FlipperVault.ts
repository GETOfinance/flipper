...
export declare namespace FlipperVault {
  ...
  export type PositionStruct = {
    ...
    riskProfile: FlipperVault.RiskProfileStruct;
  };
  ...
  export type PositionStructOutput = [
    ...
    agentAuthorized: boolean,
    riskProfile: FlipperVault.RiskProfileStructOutput
  ] & {
    bnbBalance: bigint;
    depositTimestamp: bigint;
    lastActionTimestamp: bigint;
...
export interface FlipperVaultInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "actionHistory"
      | "agentActions"
  ...
  encodeFunctionData(
    functionFragment: "totalBnbDeposited",
    values?: undefined
  ): string;
  encodeFunctionData(
...
export namespace EmergencyWithdrawalEvent {
  export type InputTuple = [user: AddressLike, bnbAmount: BigNumberish];
  export type OutputTuple = [user: string, bnbAmount: bigint];
  export interface OutputObject {
    user: string;
    bnbAmount: bigint;
  }
...
export interface FlipperVault extends BaseContract {
  connect(runner?: ContractRunner | null): FlipperVault;
  waitForDeployment(): Promise<this>;

  interface: FlipperVaultInterface;
  ...
  getAction: TypedContractMethod<
    [actionId: BigNumberish],
    [FlipperVault.ProtectionActionStructOutput],
    "view"
  >;
  ...
  getPosition: TypedContractMethod<
    [user: AddressLike],
    [FlipperVault.PositionStructOutput],
    "view"
  >;

  getRiskProfile: TypedContractMethod<
    [user: AddressLike],
    [FlipperVault.RiskProfileStructOutput],
    "view"
  >;
  ...
  totalBnbDeposited: TypedContractMethod<[], [bigint], "view">;
  ...
  getFunction(
    nameOrSignature: "totalBnbDeposited"
  ): TypedContractMethod<[], [bigint], "view">;
  getFunction(
