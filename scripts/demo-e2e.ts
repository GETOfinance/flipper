// ═══════════════════════════════════════════════════════════════
// Flipper — Full End-to-End On-Chain Demo
...
╔═══════════════════════════════════════════════════════════════╗
║                                                               ║
║   FLIPPER — END-TO-END ON-CHAIN DEMO                         ║
...
╚═══════════════════════════════════════════════════════════════╝
  ...
  console.log(`  ✓ FlipperRegistry deployed:    ${await registry.getAddress()}`);
  ...
  console.log(`  ✓ FlipperVault deployed:       ${await vault.getAddress()}`);
  ...
  const regTx = await registry.registerAgent(
    ...
    "ipfs://QmFlipperGuardianAlphaMetadata",
...
${"═".repeat(60)}
  ...
  Flipper: AI Never Sleeps. Your Guardian Always Protects.
`);
}
