...
import { FlipperRegistry } from "../typechain-types";

describe("FlipperRegistry", function () {
  ...
  describe("Deployment", function () {
    it("should set correct name and symbol", async function () {
      ...
      expect(await registry.name()).to.equal("Flipper Guardian Agent");
      expect(await registry.symbol()).to.equal("FLIPPER");
    });
